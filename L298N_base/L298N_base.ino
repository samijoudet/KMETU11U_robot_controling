...
void setup() {
  ...
  pinMode(motor1Pin1, OUTPUT); // on/off reculer puissance 100%
  pinMode(motor1Pin2, OUTPUT); // on/off avancer puissance 100%
  pinMode(enable1Pin, OUTPUT); // contrôle la vitesse
